...
var current_users = ["arsalan", "Rafay", "suleh", "Ayan", "Sohail"];
var new_users = ["sohail", "Arsalan", "Hammad", "Fakhir", "Humair"];
new_users.forEach((function (new_one_user) {
    var our_condition = current_users.some(function (current_one_user) { return current_one_user.toLowerCase() === new_one_user.toLowerCase(); });
    if (our_condition) {
        console.log("Sorry ".concat(new_one_user, " is already been used"));
    }
    else {
...
for (var a = 0; a < ordinalNum.length; a++) {
    if (ordinalNum[a] == 1) {
        console.log("".concat(ordinalNum[a], "st"));
    }
    else if (ordinalNum[a] == 2) {
        console.log("".concat(ordinalNum[a], "nd"));
    }
    else if (ordinalNum[a] == 3) {
        console.log("".concat(ordinalNum[a], "rd"));
    }
    else if (ordinalNum[a] >= 4 && ordinalNum[a] <= 9) {
        console.log("".concat(ordinalNum[a], "th"));
    }
}
//Question 34
...
var mypizza = ["Cheese Pizza", "Pepporoni Pizza", "Vageterian Pizza"];
for (var i = 0; i < mypizza.length; i++) {
    console.log("".concat(mypizza[i]));
}
for (var a = 0; a < mypizza.length; a++) {
    console.log("I really like to eat ".concat(mypizza[a], "."));
}
...
// a great pet!
var mypet = ["Dog", "Cat", "Cow", "Goat"];
for (var b = 0; b < mypet.length; b++) {
    console.log("".concat(mypet[b]));
}
for (var _i = 0, mypet_1 = mypet; _i < mypet_1.length; _i++) {
    var p = mypet_1[_i];
    console.log("".concat(p, " is a domestic animal."));
}
