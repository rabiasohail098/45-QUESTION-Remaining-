...
var favFruits = ["Mango", "Apple", "Pear", "Guava", "Peach", "Melon"];
...
var userName = ["Arsalan", "Sohail", "Hammad", "Haroon", "Rabia", "Admin"];
...
var userName1 = ["Arsalan", "Sohail", "Hammad", "Haroon", "Rabia", "Admin"];
userName1 = [];
if (userName1.length > 0) {
    ...
    console.log("\n\n".concat(userName1, " We need to find some users"));
}
